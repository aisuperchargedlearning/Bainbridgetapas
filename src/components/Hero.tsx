...
export const Hero = () => {
  ...
  return (
    <div id="hero" className="relative min-h-screen flex items-center justify-center pt-20">
      {/* Background Images */}
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto px-4">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light mb-12 leading-tight">
            Authentic
            <br />
            <span className="font-medium">Spanish Tapas</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-16 leading-relaxed max-w-2xl">
